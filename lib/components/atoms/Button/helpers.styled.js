...
exports.unstyledButton = exports.raisedButton = exports.disabledButton = exports.outlinedButton = exports.defaultButton = void 0;

var _styledComponents = require("styled-components");

var _polished = require("polished");

var _colors = require("../../../../lib/styles/colors.styled");

var _typography = require("../../../../lib/styles/typography.styled");
...
var disabledButton = (0, _styledComponents.css)(["&,&:hover,&:focus,&:active{", " background-color:", ";border-color:", ";color:", ";cursor:not-allowed;transform:translateY(0);}"], function (_ref6) {
  var raised = _ref6.raised;
  return raised && buttonBoxShadow((0, _polished.darken)(0.15, _colors.palette['grey-light']));
}, function (_ref7) {
  var outlined = _ref7.outlined;
...
var raisedButton = function raisedButton(baseColor) {
  return (0, _styledComponents.css)(["", " padding-bottom:6px;margin-bottom:4px;", ";"], buttonBoxShadow((0, _polished.darken)(0.15, _colors.palette[baseColor] || _colors.palette['grey-medium'])), function (_ref10) {
...
var unstyledButton = (0, _styledComponents.css)(["background-color:transparent;border-color:transparent;color:", ";padding-left:0;padding-right:0;&:hover,&:focus{color:", ";}"], _colors.palette['almost-black'], function (_ref11) {
